...
/**
 * Mutable Message wrapper around an Object org.apache.logging.log4j.message.
 * @since 2.6
 */
...
public class ReusableObjectMessage implements ReusableMessage, ParameterVisitable, Clearable {
    ...
    /**
     * Returns the formatted object org.apache.logging.log4j.message.
     *
     * @return the formatted object org.apache.logging.log4j.message.
     */
    @Override
    ...
    /**
     * Gets the org.apache.logging.log4j.message if it is a throwable.
     *
     * @return the org.apache.logging.log4j.message if it is a throwable.
     */
    @Override
    ...
    /**
     * This org.apache.logging.log4j.message has exactly one parameter (the object), so returns it as the first parameter in the array.
    ...
    /**
     * This org.apache.logging.log4j.message has exactly one parameter (the object), so always returns one.
     * @return 1
     */
    @Override
