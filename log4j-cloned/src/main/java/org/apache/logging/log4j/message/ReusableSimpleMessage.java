...
/**
 * Mutable Message wrapper around a String org.apache.logging.log4j.message.
 * @since 2.6
 */
...
public class ReusableSimpleMessage implements ReusableMessage, CharSequence, ParameterVisitable, Clearable {
    ...
    /**
     * This org.apache.logging.log4j.message does not have any parameters, so this method returns the specified array.
    ...
    /**
     * This org.apache.logging.log4j.message does not have any parameters so this method always returns zero.
     * @return 0 (zero)
     */
    @Override
