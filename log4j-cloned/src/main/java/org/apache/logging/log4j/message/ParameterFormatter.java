...
final class ParameterFormatter {
     ...
     * Replace placeholders in the given messagePattern with arguments.
     *
     * @param buffer the buffer to write the formatted org.apache.logging.log4j.message into
     * @param messagePattern the org.apache.logging.log4j.message pattern containing placeholders.
     * @param arguments      the arguments to be used to replace placeholders.
     */
    ...
    /**
     * Returns {@code true} if the specified char and the char at {@code curCharIndex + 1} in the specified org.apache.logging.log4j.message
    ...
    /**
     * Detects whether the org.apache.logging.log4j.message pattern has been fully processed or if an unprocessed character remains and processes
     ...
     * '\' escape chars encountered in the org.apache.logging.log4j.message format and returns the resulting position.
     */
    // Profiling showed this method is important to log4j performance. Modify with care!
    // 11 bytes (allows immediate JVM inlining: < 35 bytes) LOG4J2-1096
