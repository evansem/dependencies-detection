 ...
 *
 * Uses the JAnsi rendering syntax as the default to render a org.apache.logging.log4j.message into an ANSI escaped string.
 *
 ...
 * </pre>
 *
 * For example, to render the org.apache.logging.log4j.message {@code "Hello"} in green, use:
 *
 * <pre>
 *   &#64;|green Hello|@
 * </pre>
 *
 * To render the org.apache.logging.log4j.message {@code "Hello"} in bold and red, use:
 *
 * <pre>
 *   &#64;|bold,red Warning!|@
 * </pre>
 ...
 *
 * <pre>
 * %org.apache.logging.log4j.message{ansi}{StyleName=value(,value)*( StyleName=value(,value)*)*}%n
 * </pre>
 *
 * For example:
 *
 * <pre>
 * %org.apache.logging.log4j.message{ansi}{WarningStyle=red,bold KeyStyle=white ValueStyle=blue}%n
 * </pre>
 *
