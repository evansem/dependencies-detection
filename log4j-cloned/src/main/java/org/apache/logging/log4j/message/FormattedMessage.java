...
public class FormattedMessage implements Message {
    ...
    /**
     * Gets the org.apache.logging.log4j.message pattern.
    ...
    /**
     * Gets the formatted org.apache.logging.log4j.message.
    ...
    protected Message getMessage(final String msgPattern, final Object[] args, final Throwable aThrowable) {
        try {
            ...
            // Obviously, the org.apache.logging.log4j.message is not a proper pattern for MessageFormat.
        }
        try {
    ...
    /**
     * Gets the org.apache.logging.log4j.message parameters.
