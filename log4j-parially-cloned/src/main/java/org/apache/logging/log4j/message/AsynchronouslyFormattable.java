 ...
 * the logger is called and the time the log org.apache.logging.log4j.message is formatted and written to disk. Strictly speaking it is the
 ...
 * will copy the org.apache.logging.log4j.message content (formatted org.apache.logging.log4j.message, parameters) onto the queue rather than passing the
 * {@code Message} instance itself. This ensures that the formatted org.apache.logging.log4j.message will not change
 ...
 * of the mutable object. The intention is that the Message implementation caches this formatted org.apache.logging.log4j.message and returns
