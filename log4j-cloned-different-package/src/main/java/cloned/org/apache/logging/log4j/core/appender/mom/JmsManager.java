...
package cloned.org.apache.logging.log4j.core.appender.mom;
...
import cloned.org.apache.logging.log4j.core.appender.AbstractManager;
import cloned.org.apache.logging.log4j.core.appender.AppenderLoggingException;
import cloned.org.apache.logging.log4j.core.appender.ManagerFactory;
import cloned.org.apache.logging.log4j.core.net.JndiManager;
import cloned.org.apache.logging.log4j.core.util.Log4jThread;
import cloned.org.apache.logging.log4j.status.StatusLogger;
import cloned.org.apache.logging.log4j.util.BiConsumer;
import cloned.org.apache.logging.log4j.core.Layout;
import cloned.org.apache.logging.log4j.core.layout.MessageLayout;
import cloned.org.apache.logging.log4j.core.layout.PatternLayout;
import cloned.org.apache.logging.log4j.core.layout.SerializedLayout;
...
public class JmsManager extends AbstractManager {
     ...
     * <p>
     * For instance, when using a text-based {@link Layout} such as
     * {@link PatternLayout}, the {@link LogEvent}
     * org.apache.logging.log4j.message will be serialized to a String.
     * </p>
     * <p>
     * When using a layout such as {@link SerializedLayout}, the LogEvent org.apache.logging.log4j.message
     * will be serialized as a Java object.
     * </p>
     * <p>
     * When using a layout such as {@link MessageLayout} and the LogEvent org.apache.logging.log4j.message
     * is a Log4j MapMessage, the org.apache.logging.log4j.message will be serialized as a JMS MapMessage.
     * </p>
     *
     * @param object
     *            The LogEvent or String org.apache.logging.log4j.message to wrap.
     * @return A new JMS org.apache.logging.log4j.message containing the provided object.
     * @throws JMSException
     */
    public Message createMessage(final Serializable object) throws JMSException {
        ...
        } else if (object instanceof cloned.org.apache.logging.log4j.message.MapMessage) {
            return map((cloned.org.apache.logging.log4j.message.MapMessage<?, ?>) object, this.session.createMapMessage());
        }
    ...
    private MapMessage map(final cloned.org.apache.logging.log4j.message.MapMessage<?, ?> log4jMapMessage,
            final MapMessage jmsMapMessage) {
        // Map without calling org.apache.logging.log4j.org.apache.logging.log4j.message.MapMessage#getData() which makes a copy of the map.
            ...
            if (reconnector != null && !configuration.isImmediateFail()) {
                ...
                if (messageProducer == null) {
                    throw new AppenderLoggingException(
                            "Error sending to JMS Manager '" + getName() + "': JMS org.apache.logging.log4j.message producer not available");
                }
            }
        }
        synchronized (this) {
