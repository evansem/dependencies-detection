...
public final class OptionConverter {
    ...
    public static Level toLevel(String value, Level defaultValue) {
        ...
        if (hashIndex == -1) {
            if("NULL".equalsIgnoreCase(value)) {
                ...
                // no class name specified : use standard org.apache.logging.log4j.Level class
        ...
        try {
            ...
            // toLevel(String, org.apache.log4j.org.apache.logging.log4j.Level)
            ...
            LOGGER.warn("custom level class [" + clazz + "]"
                + " does not have a class function toLevel(String, org.apache.logging.log4j.Level)", e);
            ...
            LOGGER.warn("class [" + clazz + "] is not a subclass of org.apache.log4j.org.apache.logging.log4j.Level", e);
    ...
    public static String substVars(final String val, final Properties props) throws
        ...
        while (true) {
            ...
            if (j == -1) {
                // no more variables
                if (i == 0) { // this is a org.apache.logging.log4j.simple string
                    return val;
                }
