...
public final class DynamicThresholdFilter extends AbstractFilter {
     ...
     * @param pairs An array of value and org.apache.logging.log4j.Level pairs.
     * @param defaultThreshold The default org.apache.logging.log4j.Level.
    ...
    private DynamicThresholdFilter(final String key, final Map<String, Level> pairs, final Level defaultLevel,
                                   final Filter.Result onMatch, final Filter.Result onMismatch) {
