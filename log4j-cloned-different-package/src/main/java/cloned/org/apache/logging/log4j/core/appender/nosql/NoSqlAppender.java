 ...
 * <p>
 * For examples on how to write your own NoSQL provider, see the org.apache.logging.log4j.simple source code for the MongoDB and CouchDB
 * providers.
 * </p>
 *
 * @see NoSqlObject
...
public final class NoSqlAppender extends AbstractDatabaseAppender<NoSqlDatabaseManager<?>> {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractAppender.Builder<B>
            implements cloned.org.apache.logging.log4j.core.util.Builder<NoSqlAppender> {
        ...
        public NoSqlAppender build() {
            ...
            if (provider == null) {
                AbstractLifeCycle.LOGGER.error("NoSQL provider not specified for appender [{}].", name);
                return null;
            }
