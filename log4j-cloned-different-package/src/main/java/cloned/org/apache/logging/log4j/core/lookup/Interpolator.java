...
import cloned.org.apache.logging.log4j.core.config.ConfigurationAware;
    ...
    public Interpolator(final Map<String, String> properties) {
        ...
        try {
            ...
            strLookupMap.put(LOOKUP_KEY_JNDI,
                Loader.newCheckedInstanceOf("org.apache.logging.log4j.org.apache.logging.log4j.core.lookup.JndiLookup", StrLookup.class));
        ...
        try {
            ...
            strLookupMap.put(LOOKUP_KEY_JVMRUNARGS,
                Loader.newCheckedInstanceOf("org.apache.logging.log4j.org.apache.logging.log4j.core.lookup.JmxRuntimeInputArgumentsLookup",
                        StrLookup.class));
        } catch (final LinkageError | Exception e) {
    ...
    private void handleError(final String lookupKey, final Throwable t) {
        switch (lookupKey) {
            case LOOKUP_KEY_JNDI:
                // java.lang.VerifyError: org/apache/logging/log4j/org.apache.logging.log4j.core/lookup/JndiLookup
            ...
            case LOOKUP_KEY_JVMRUNARGS:
                // java.lang.VerifyError: org/apache/logging/log4j/org.apache.logging.log4j.core/lookup/JmxRuntimeInputArgumentsLookup
                LOGGER.warn(
