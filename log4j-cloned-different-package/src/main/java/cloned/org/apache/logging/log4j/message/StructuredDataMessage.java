...
import cloned.org.apache.logging.log4j.util.EnglishEnums;
import cloned.org.apache.logging.log4j.util.StringBuilders;

/**
 * Represents a Message that conforms to an RFC 5424 StructuredData element along with the syslog org.apache.logging.log4j.message.
 * <p>
 * Thread-safety note: the contents of this org.apache.logging.log4j.message can be modified after construction.
 * When using asynchronous loggers and appenders it is not recommended to modify this org.apache.logging.log4j.message after the org.apache.logging.log4j.message is
 * logged, because it is undefined whether the logged org.apache.logging.log4j.message string will contain the old values or the modified
 * values.
 * </p>
 *
...
public class StructuredDataMessage extends MapMessage<StructuredDataMessage, String> {
    ...
    public enum Format {
        ...
        XML,
        /** Full org.apache.logging.log4j.message format includes the type and org.apache.logging.log4j.message. */
        FULL
    }

    /**
     * Creates a StructuredDataMessage using an ID (max 32 characters), org.apache.logging.log4j.message, and type (max 32 characters).
     * @param id The String id.
     * @param msg The org.apache.logging.log4j.message.
     * @param type The org.apache.logging.log4j.message type.
     */
    ...
    /**
     * Creates a StructuredDataMessage using an ID (user specified max characters), org.apache.logging.log4j.message, and type (user specified
    ...
    /**
     * Creates a StructuredDataMessage using an ID (max 32 characters), org.apache.logging.log4j.message, type (max 32 characters), and an
    ...
    /**
     * Creates a StructuredDataMessage using an (user specified max characters), org.apache.logging.log4j.message, and type (user specified
    ...
    /**
     * Creates a StructuredDataMessage using a StructuredDataId, org.apache.logging.log4j.message, and type (max 32 characters).
    ...
    /**
     * Creates a StructuredDataMessage using a StructuredDataId, org.apache.logging.log4j.message, type (max 32 characters), and an initial map
    ...
    /**
     * Returns this org.apache.logging.log4j.message id.
    ...
    /**
     * Returns this org.apache.logging.log4j.message type.
     * @return the type.
     */
    ...
    /**
     * Returns the org.apache.logging.log4j.message.
     * @return the org.apache.logging.log4j.message.
     */
    @Override
     ...
     * Formats the structured data as described in RFC 5424.
     *
     * @param format           "full" will include the type and org.apache.logging.log4j.message. null will return only the STRUCTURED-DATA as
     ...
     * @param structuredDataId The SD-ID as described in RFC 5424. If null the value in the StructuredData
     *                         will be used.
     * @param sb The StringBuilder to append the formatted org.apache.logging.log4j.message to.
     */
    ...
    /**
     * Formats the org.apache.logging.log4j.message and return it.
     * @return the formatted org.apache.logging.log4j.message.
     */
    @Override
    ...
    /**
     * Formats the org.apache.logging.log4j.message according the the specified format.
     * @param formats An array of Strings that provide extra information about how to format the org.apache.logging.log4j.message.
     * StructuredDataMessage accepts only a format of "FULL" which will cause the event type to be
     * prepended and the event org.apache.logging.log4j.message to be appended. Specifying any other value will cause only the
