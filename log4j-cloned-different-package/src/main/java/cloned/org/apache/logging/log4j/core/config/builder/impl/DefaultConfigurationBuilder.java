 ...
 */
package cloned.org.apache.logging.log4j.core.config.builder.impl;
...
import cloned.org.apache.logging.log4j.core.config.builder.api.Component;
...
import cloned.org.apache.logging.log4j.core.config.builder.api.CustomLevelComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.FilterComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.KeyValuePairComponentBuilder;
...
import cloned.org.apache.logging.log4j.core.config.builder.api.PropertyComponentBuilder;
...
import cloned.org.apache.logging.log4j.core.util.Throwables;
    ...
    public ConfigurationBuilder<T> add(final RootLoggerComponentBuilder builder) {
        for (final Component c : loggers.getComponents()) {
            if (c.getPluginType().equals(LoggerConfig.ROOT)) {
                throw new ConfigurationException("Root org.apache.logging.log4j.Logger was previously defined");
            }
        }
        return add(loggers, builder);
    }
