...
public interface Filter extends LifeCycle {
     ...
     */
     enum Result {
        /**
         * The event will be processed without further filtering based on the log org.apache.logging.log4j.Level.
         */
        ACCEPT,
        /**
    ...
    /**
     * Filter an event.
     * @param logger The org.apache.logging.log4j.Logger.
     * @param level The event logging org.apache.logging.log4j.Level.
     * @param marker The org.apache.logging.log4j.Marker for the event or null.
