 ...
 * requiring complicated formatters and as a way to manipulate the org.apache.logging.log4j.message based on information available
 ...
 * a org.apache.logging.log4j.Logger method.
 * </p>
 *
...
public interface Message extends Serializable {
     ...
     * org.apache.logging.log4j.message implements {@link ReusableMessage} or is annotated with {@link AsynchronouslyFormattable}.
     * This gives the Message implementation class a chance to create a formatted org.apache.logging.log4j.message String with the current value
     * of any mutable objects.
     * The intention is that the Message implementation caches this formatted org.apache.logging.log4j.message and returns it on subsequent
     ...
     * </p>
     *
     * @return The org.apache.logging.log4j.message String.
     */
     ...
     *
     * @return The org.apache.logging.log4j.message format. Some implementations, such as ParameterizedMessage, will use this as
     * the org.apache.logging.log4j.message "pattern". Other Messages may simply return an empty String.
     * TODO Do all messages have a format?  What syntax?  Using a Formatter object could be cleaner.
     * (RG) In SimpleMessage the format is identical to the formatted org.apache.logging.log4j.message. In ParameterizedMessage and
