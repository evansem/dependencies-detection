...
import cloned.org.apache.logging.log4j.core.util.CloseShieldOutputStream;
...
public final class ConsoleAppender extends AbstractOutputStreamAppender<OutputStreamManager> {
     ...
     * @param name The name of the Appender (required).
     * @param follow If true will follow changes to the underlying output stream.
     * @param direct If true will write directly to {@link FileDescriptor} and bypass
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements cloned.org.apache.logging.log4j.core.util.Builder<ConsoleAppender> {
