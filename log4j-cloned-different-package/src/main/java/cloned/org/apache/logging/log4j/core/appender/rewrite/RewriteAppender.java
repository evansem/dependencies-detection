 ...
 */
package cloned.org.apache.logging.log4j.core.appender.rewrite;
...
public final class RewriteAppender extends AbstractAppender {
    ...
    public void start() {
        for (final AppenderRef ref : appenderRefs) {
            ...
            if (appender != null) {
                ...
                AbstractLifeCycle.LOGGER.error("Appender " + ref + " cannot be located. Reference ignored");
            }
        }
        super.start();
    }
    ...
    public static RewriteAppender createAppender(
        ...
        if (name == null) {
            AbstractLifeCycle.LOGGER.error("No name provided for RewriteAppender");
            return null;
        }
        if (appenderRefs == null) {
            AbstractLifeCycle.LOGGER.error("No appender references defined for RewriteAppender");
            return null;
        }
