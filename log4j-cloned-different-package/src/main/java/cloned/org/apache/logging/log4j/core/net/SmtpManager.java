 ...
 */
package cloned.org.apache.logging.log4j.core.net;
...
import cloned.org.apache.logging.log4j.core.layout.AbstractStringLayout.Serializer;
...
import cloned.org.apache.logging.log4j.core.util.CyclicBuffer;
...
public class SmtpManager extends AbstractManager {
    ...
    /**
     * Send the contents of the cyclic buffer as an e-mail org.apache.logging.log4j.message.
    ...
    private synchronized void connect(final LogEvent appendEvent) {
        ...
        try {
            ...
            logError("Could not set SmtpAppender org.apache.logging.log4j.message options", e);
            message = null;
        }
    }
