 ...
 * 
 * @param <L> the org.apache.logging.log4j.Logger class to adapt
 * @since 2.1
 */
public abstract class AbstractLoggerAdapter<L> implements LoggerAdapter<L>, LoggerContextShutdownAware {
     ...
     * {@code ContextSelector} class in {@code log4j-org.apache.logging.log4j.core}. However, implementations can rely on their own framework's
