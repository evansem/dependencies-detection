...
import cloned.org.apache.logging.log4j.util.StringBuilderFormattable;

/**
 * Applications create Markers by using the org.apache.logging.log4j.Marker Manager. All Markers created by this Manager are immutable.
 */
public final class MarkerManager {
    ...
    /**
     * Retrieves a org.apache.logging.log4j.Marker or create a org.apache.logging.log4j.Marker that has no parent.
     *
     * @param name The name of the org.apache.logging.log4j.Marker.
     * @return The org.apache.logging.log4j.Marker with the specified name.
    ...
    /**
     * Retrieves or creates a org.apache.logging.log4j.Marker with the specified parent. The parent must have been previously created.
     *
     * @param name The name of the org.apache.logging.log4j.Marker.
     * @param parent The name of the parent org.apache.logging.log4j.Marker.
     * @return The org.apache.logging.log4j.Marker with the specified name.
     * @throws IllegalArgumentException if the parent org.apache.logging.log4j.Marker does not exist.
     * @deprecated Use the org.apache.logging.log4j.Marker add or set methods to add parent Markers. Will be removed by final GA release.
     */
    @Deprecated
    public static Marker getMarker(final String name, final String parent) {
        final Marker parentMarker = MARKERS.get(parent);
        if (parentMarker == null) {
            throw new IllegalArgumentException("Parent org.apache.logging.log4j.Marker " + parent + " has not been defined");
        }
        return getMarker(name, parentMarker);
    }

    /**
     * Retrieves or creates a org.apache.logging.log4j.Marker with the specified parent.
     *
     * @param name The name of the org.apache.logging.log4j.Marker.
     * @param parent The parent org.apache.logging.log4j.Marker.
     * @return The org.apache.logging.log4j.Marker with the specified name.
     ...
     * <p>
     * The actual org.apache.logging.log4j.Marker implementation.
     * </p>
     * <p>
     * <em>Internal note: We could make this class package private instead of public if the class
     * {@code org.apache.logging.log4j.org.apache.logging.log4j.core.jackson.MarkerMixIn}
    ...
    public static class Log4jMarker implements Marker, StringBuilderFormattable {
        ...
        /**
         * Constructs a new org.apache.logging.log4j.Marker.
         *
         * @param name the name of the org.apache.logging.log4j.Marker.
         * @throws IllegalArgumentException if the argument is {@code null}
         */
        public Log4jMarker(final String name) {
            // we can't store null references in a ConcurrentHashMap as it is, not to mention that a null org.apache.logging.log4j.Marker
            // name seems rather pointless. To get an "anonymous" org.apache.logging.log4j.Marker, just use an empty string.
            requireNonNull(name, "org.apache.logging.log4j.Marker name cannot be null.");
            this.name = name;
            this.parents = null;
        }

        // TODO: use java.org.apache.logging.log4j.util.concurrent
    ...
    // this method wouldn't be necessary if org.apache.logging.log4j.Marker methods threw an NPE instead of an IAE for null values ;)
