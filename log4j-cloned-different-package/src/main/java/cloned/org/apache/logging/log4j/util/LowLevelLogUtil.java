...
/**
 * PrintWriter-based logging utility for classes too low level to use {@link StatusLogger}.
 * Such classes cannot use StatusLogger as StatusLogger or {@link SimpleLogger} depends
...
final class LowLevelLogUtil {
    ...
    /**
     * Logs the given org.apache.logging.log4j.message.
     * 
