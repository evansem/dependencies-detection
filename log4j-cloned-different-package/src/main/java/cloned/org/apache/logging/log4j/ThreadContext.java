...
import cloned.org.apache.logging.log4j.spi.DefaultThreadContextMap;
import cloned.org.apache.logging.log4j.spi.DefaultThreadContextStack;
import cloned.org.apache.logging.log4j.spi.NoOpThreadContextMap;
import cloned.org.apache.logging.log4j.spi.ReadOnlyThreadContextMap;
import cloned.org.apache.logging.log4j.spi.ThreadContextMap;
import cloned.org.apache.logging.log4j.spi.ThreadContextMap2;
import cloned.org.apache.logging.log4j.spi.CleanableThreadContextMap;
import cloned.org.apache.logging.log4j.spi.ThreadContextMapFactory;
import cloned.org.apache.logging.log4j.spi.ThreadContextStack;
import cloned.org.apache.logging.log4j.util.PropertiesUtil;

/**
 * The org.apache.logging.log4j.ThreadContext allows applications to store information either in a Map or a Stack.
 * <p>
 * <b><em>The MDC is managed on a per thread basis</em></b>. To enable automatic inheritance of <i>copies</i> of the MDC
 * to newly created threads, enable the {@value DefaultThreadContextMap#INHERITABLE_MAP}
...
public final class ThreadContext {
    ...
    private static class EmptyThreadContextStack extends AbstractCollection<String> implements ThreadContextStack {
        ...
        public boolean equals(final Object o) {
            // Similar to java.org.apache.logging.log4j.util.Collections.EmptyList.equals(Object)
            return (o instanceof Collection) && ((Collection<?>) o).isEmpty();
        }

        @Override
        public int hashCode() {
            // Same as java.org.apache.logging.log4j.util.Collections.EmptyList.hashCode()
            return 1;
        }
     ...
     *
     * @return An immutable view of the org.apache.logging.log4j.ThreadContext Map.
     */
    ...
    /**
     * Returns a read-only view of the org.apache.logging.log4j.internal data structure used to store thread context key-value pairs,
     * or {@code null} if the org.apache.logging.log4j.internal data structure does not implement the
     ...
     * </p>
     *
     * @return the org.apache.logging.log4j.internal data structure used to store thread context key-value pairs or {@code null}
     * @see ThreadContextMapFactory
     * @see DefaultThreadContextMap
     * @see cloned.log4j.spi.CopyOnWriteSortedArrayThreadContextMap
     * @see cloned.log4j.spi.GarbageFreeSortedArrayThreadContextMap
     * @since 2.8
     */
     ...
     *
     * @return an immutable copy of the org.apache.logging.log4j.ThreadContext stack.
     */
     ...
     *
     * <p>
     * The contents of the <code>org.apache.logging.log4j.message</code> parameter is determined solely by the client.
     * </p>
     *
     ...
     *
     * <p>
     * The contents of the <code>org.apache.logging.log4j.message</code> and args parameters are determined solely by the client. The org.apache.logging.log4j.message
     ...
     *
     * @param message The new diagnostic context information.
     * @param args Parameters for the org.apache.logging.log4j.message.
     */
     ...
     * the end of complex call sequences, the depth of the org.apache.logging.log4j.ThreadContext is unpredictable. The <code>trim</code> method
     ...
     * <pre>
     * void foo() {
     *     final int depth = org.apache.logging.log4j.ThreadContext.getDepth();
     *
     *     // ... complex sequence of calls
     *
     *     org.apache.logging.log4j.ThreadContext.trim(depth);
     * }
     * </pre>
     *
     * <p>
    ...
    /**
     * The org.apache.logging.log4j.ThreadContext Stack interface.
     */
