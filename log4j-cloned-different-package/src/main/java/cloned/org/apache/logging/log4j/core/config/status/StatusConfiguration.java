...
package cloned.org.apache.logging.log4j.core.config.status;
...
import cloned.org.apache.logging.log4j.status.StatusConsoleListener;
import cloned.org.apache.logging.log4j.status.StatusListener;
...
public class StatusConfiguration {
    ...
    /**
     * Logs an error org.apache.logging.log4j.message to the StatusLogger. If the StatusLogger hasn't been set up yet, queues the org.apache.logging.log4j.message to be
     * logged after initialization.
     *
     * @param message error org.apache.logging.log4j.message to log.
     */
     ...
     * out will be used.
     *
     * @param destination where org.apache.logging.log4j.status log messages should be output.
     * @return {@code this}
     */
    ...
    public StatusConfiguration withStatus(final String status) {
        ...
        if (this.status == null) {
            this.error("Invalid org.apache.logging.log4j.status level specified: " + status + ". Defaulting to ERROR.");
     ...
     *
     * @param verbosity basic filter for org.apache.logging.log4j.status logger messages.
     * @return {@code this}
     */
