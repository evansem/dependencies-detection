 ...
 */
package cloned.org.apache.logging.log4j.core.jmx;

import java.util.List;

import javax.management.ObjectName;

import cloned.org.apache.logging.log4j.status.StatusData;
...
public interface StatusLoggerAdminMBean {
     ...
     * and a {@code null} org.apache.logging.log4j.message.
     */
    String NOTIF_TYPE_DATA = "com.apache.logging.log4j.org.apache.logging.log4j.core.jmx.statuslogger.data";

    /**
     * Notifications with this type have a formatted org.apache.logging.log4j.status data org.apache.logging.log4j.message string
     * but no {@code StatusData} in their userData field.
     */
    String NOTIF_TYPE_MESSAGE = "com.apache.logging.log4j.org.apache.logging.log4j.core.jmx.statuslogger.org.apache.logging.log4j.message";

    /**
     * Returns the {@code ObjectName} that this org.apache.logging.log4j.status logger mbean is registered with.
     ...
     * org.apache.logging.log4j.status history. The list has up to 200 entries by default but the length
     * can be configured with system property {@code "log4j2.org.apache.logging.log4j.status.entries"}.
     * <p>
    ...
    /**
     * Returns a string array with the most recent messages in the org.apache.logging.log4j.status
     * history. The list has up to 200 entries by default but the length can be
     * configured with system property {@code "log4j2.org.apache.logging.log4j.status.entries"}.
     *
     * @return the most recent messages logged by the {@code StatusLogger}.
     */
