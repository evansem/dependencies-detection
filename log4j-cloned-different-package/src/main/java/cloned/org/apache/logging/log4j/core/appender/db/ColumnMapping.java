 ...
 */
package cloned.org.apache.logging.log4j.core.appender.db;
...
public class ColumnMapping {
     ...
     */
    public static class Builder implements cloned.org.apache.logging.log4j.core.util.Builder<ColumnMapping> {
        ...
        public ColumnMapping build() {
            ...
            if (!(layout == null
                ...
                LOGGER.error("No 'layout' or 'literal' value specified and type ({}) is not compatible with ThreadContextMap, ThreadContextStack, or java.org.apache.logging.log4j.util.Date for the mapping", type, this);
                return null;
            }
        ...
        /**
         * Source name. Useful when combined with a {@link MapMessage} depending on the
         * appender.
         *
         * @return this.
         */
