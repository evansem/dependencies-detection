...
public final class StackLocator {
    ...
    private boolean isValid(final StackTraceElement element) {
        ...
        // ignore OpenJDK org.apache.logging.log4j.internal classes involved with reflective invocation
        ...
        if (cn.startsWith("jdk.org.apache.logging.log4j.internal.reflect.")) {
            return false;
        }
