...
public final class BurstFilter extends AbstractFilter {
    ...
    /**
     * org.apache.logging.log4j.Level of messages to be filtered. Anything at or below this level will be
    ...
    private BurstFilter(final Level level, final float rate, final long maxBurst, final Filter.Result onMatch,
    ...
    public static class Builder extends AbstractFilterBuilder<Builder> implements cloned.org.apache.logging.log4j.core.util.Builder<BurstFilter> {
