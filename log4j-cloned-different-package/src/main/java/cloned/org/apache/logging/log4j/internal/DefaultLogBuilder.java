 ...
 */
package cloned.org.apache.logging.log4j.internal;
...
public class DefaultLogBuilder implements LogBuilder {
    ...
    /**
     * This method should be considered org.apache.logging.log4j.internal. It is used to reset the org.apache.logging.log4j.LogBuilder for a new log org.apache.logging.log4j.message.
     * @param level The logging level for this event.
     * @return This org.apache.logging.log4j.LogBuilder instance.
     */
    ...
    private boolean isValid() {
        if (!inUse) {
            LOGGER.warn("Attempt to reuse org.apache.logging.log4j.LogBuilder was ignored. {}",
                    StackLocatorUtil.getCallerClass(2));
            return false ;
        }
        if (this.threadId != Thread.currentThread().getId()) {
            LOGGER.warn("org.apache.logging.log4j.LogBuilder can only be used on the owning thread. {}",
                    StackLocatorUtil.getCallerClass(2));
            return false;
        }
        return true;
