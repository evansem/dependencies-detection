 ...
 * Message instances are cached in a ThreadLocal and reused when a new org.apache.logging.log4j.message is requested within the same thread.
...
public final class ReusableMessageFactory implements MessageFactory2, Serializable {
    ...
    /**
     * Constructs a org.apache.logging.log4j.message factory.
     */
     ...
     * This flag is used internally to verify that a reusable org.apache.logging.log4j.message is no longer in use and
     * can be reused.
     * @param message the org.apache.logging.log4j.message to make available again
     * @since 2.7
     */
     ...
     *
     * @param message The org.apache.logging.log4j.message pattern.
     ...
     *
     * @param message The org.apache.logging.log4j.message String.
     * @return The Message.
     *
     ...
     *
     * @param message The org.apache.logging.log4j.message Object.
     * @return The Message.
     *
