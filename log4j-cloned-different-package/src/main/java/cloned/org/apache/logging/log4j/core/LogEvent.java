...
import cloned.org.apache.logging.log4j.core.impl.ThrowableProxy;
...
/**
 * Provides contextual information about a logged org.apache.logging.log4j.message. A LogEvent must be {@link Serializable} so that it
 * may be transmitted over a network connection, output in a
 * {@link SerializedLayout}, and many other uses. Besides containing a
 * {@link Message}, a LogEvent has a corresponding
 * {@link Level} that the org.apache.logging.log4j.message was logged at. If a
 * {@link Marker} was used, then it is included here. The contents of the
 * {@link ThreadContext} at the time of the log call are provided via
 * {@link #getContextMap()} and {@link #getContextStack()}. If a {@link Throwable} was included in the log
 * call, then it is provided via {@link #getThrown()}. When this class is serialized, the attached Throwable will
 * be wrapped into a {@link ThrowableProxy} so that it may be safely serialized
 ...
 * can carry both {@code org.apache.logging.log4j.ThreadContext} data as well as other context data supplied by the
 * {@linkplain ContextDataInjectorFactory configured}
...
public interface LogEvent extends Serializable {
     ...
     * configured on the org.apache.logging.log4j.Logger that logged the event), but users can configure a custom {@link ContextDataInjector}
    ...
    /**
     * Gets the org.apache.logging.log4j.Marker associated with the event.
     *
     * @return org.apache.logging.log4j.Marker or {@code null} if no org.apache.logging.log4j.Marker was defined on this LogEvent
     */
    Marker getMarker();

    /**
     * Gets the org.apache.logging.log4j.message associated with the event.
     *
     * @return org.apache.logging.log4j.message.
     */
    Message getMessage();
    ...
    /**
     * Returns the Instant when the org.apache.logging.log4j.message was logged.
     * <p>
