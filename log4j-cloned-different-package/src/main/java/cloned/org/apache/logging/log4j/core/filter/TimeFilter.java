...
public final class TimeFilter extends AbstractFilter {
     ...
     */
    TimeFilter(final LocalTime start, final LocalTime end, final ZoneId timeZone, final Filter.Result onMatch,
               final Filter.Result onMismatch, LocalDate now) {
    ...
    private TimeFilter(final LocalTime start, final LocalTime end, final ZoneId timeZone, final Filter.Result onMatch,
    ...
    private static LocalTime parseTimestamp(final String timestamp, final LocalTime defaultValue) {
        ...
        try {
            ...
            AbstractLifeCycle.LOGGER.warn("Error parsing TimeFilter timestamp value {}", timestamp, e);
            return defaultValue;
        }
    }
