...
import static cloned.org.apache.logging.log4j.core.util.ShutdownCallbackRegistry.SHUTDOWN_HOOK_MARKER;
...
import cloned.org.apache.logging.log4j.core.config.ConfigurationFactory;
import cloned.org.apache.logging.log4j.core.config.ConfigurationListener;
import cloned.org.apache.logging.log4j.core.config.ConfigurationSource;
import cloned.org.apache.logging.log4j.core.config.DefaultConfiguration;
import cloned.org.apache.logging.log4j.core.config.NullConfiguration;
import cloned.org.apache.logging.log4j.core.config.Reconfigurable;
import cloned.org.apache.logging.log4j.core.impl.Log4jLogEvent;
import cloned.org.apache.logging.log4j.core.impl.ThreadContextDataInjector;
import cloned.org.apache.logging.log4j.core.jmx.Server;
import cloned.org.apache.logging.log4j.core.util.Cancellable;
import cloned.org.apache.logging.log4j.core.util.ExecutorServices;
import cloned.org.apache.logging.log4j.core.util.Loader;
import cloned.org.apache.logging.log4j.core.util.NetUtils;
import cloned.org.apache.logging.log4j.core.util.ShutdownCallbackRegistry;
...
import cloned.org.apache.logging.log4j.spi.LoggerContextShutdownAware;
import cloned.org.apache.logging.log4j.spi.LoggerContextShutdownEnabled;
import cloned.org.apache.logging.log4j.spi.LoggerRegistry;
import cloned.org.apache.logging.log4j.spi.Terminable;
import cloned.org.apache.logging.log4j.spi.ThreadContextMapFactory;
...
public class LoggerContext extends AbstractLifeCycle
        implements cloned.org.apache.logging.log4j.spi.LoggerContext, AutoCloseable, Terminable, ConfigurationListener,
     ...
     *
     * <pre>
     * (LoggerContext) org.apache.logging.log4j.LogManager.getContext();
     * </pre>
     *
     * <p>
     ...
     *
     * <pre>
     * (LoggerContext) org.apache.logging.log4j.LogManager.getContext(currentContext);
     * </pre>
     *
     ...
     *
     * <pre>
     * (LoggerContext) org.apache.logging.log4j.LogManager.getContext(loader, currentContext, configLocation);
     * </pre>
     *
    ...
    public boolean stop(final long timeout, final TimeUnit timeUnit) {
        ...
        LOGGER.debug("Stopped LoggerContext[name={}, {}] with org.apache.logging.log4j.status {}", getName(), this, true);
        return true;
    }
    ...
    /**
     * Gets a org.apache.logging.log4j.Logger from the Context.
     *
    ...
    /**
     * Obtains a org.apache.logging.log4j.Logger from the Context.
     *
     * @param name The name of the org.apache.logging.log4j.Logger to return.
    ...
    /**
     * Determines if the specified org.apache.logging.log4j.Logger exists.
     *
    ...
    /**
     * Causes all org.apache.logging.log4j.Logger to be updated against the specified Configuration.
     *
    ...
    private void initApiModule() {
        ThreadContextMapFactory.init(); // Or make public and call org.apache.logging.log4j.ThreadContext.init() which calls ThreadContextMapFactory.init().
    }
