 ...
 * <pre>
 * try (final org.apache.logging.log4j.CloseableThreadContext.Instance ignored = org.apache.logging.log4j.CloseableThreadContext.put(key1, value1).put(key2, value2)) {
 *     callSomeMethodThatLogsALot();
 *
 * // Entries for key1 and key2 are automatically removed from the org.apache.logging.log4j.ThreadContext map when done.
 * }
 * </pre>
 *
 * @since 2.6
