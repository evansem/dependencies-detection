 ...
 */
package cloned.org.apache.logging.log4j.simple;
...
import cloned.org.apache.logging.log4j.spi.ExtendedLogger;
...
public class SimpleLoggerContext implements LoggerContext {
    ...
    /** Include the instance name in the log org.apache.logging.log4j.message? */
    private final boolean showLogName;

    /**
     * Include the short name (last component) of the logger in the log org.apache.logging.log4j.message. Defaults to true - otherwise we'll be
     * lost in a flood of messages without knowing who sends them.
     */
    private final boolean showShortName;
    /** Include the current time in the log org.apache.logging.log4j.message */
    private final boolean showDateTime;
    /** Include the ThreadContextMap in the log org.apache.logging.log4j.message */
    private final boolean showContextMap;
    /** The date and time format to use in the log org.apache.logging.log4j.message */
