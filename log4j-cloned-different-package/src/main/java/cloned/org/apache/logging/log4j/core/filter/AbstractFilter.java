 ...
 * which case it will only implement the required method(s). The rest will default to return {@link Filter.Result#NEUTRAL}.
 * <p>
...
public abstract class AbstractFilter extends AbstractLifeCycle implements Filter {
     ...
     * @param marker The org.apache.logging.log4j.Marker, if any.
     * @param msg The org.apache.logging.log4j.message, if present.
