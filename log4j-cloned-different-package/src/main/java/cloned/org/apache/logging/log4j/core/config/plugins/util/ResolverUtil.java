 ...
 *
 * <p>
 * General searches are initiated by calling the {@link #find(Test, String...)} method and supplying a
...
public class ResolverUtil {
    ...
    /**
     * A org.apache.logging.log4j.simple interface that specifies how to test classes to determine if they are to be included in the results
