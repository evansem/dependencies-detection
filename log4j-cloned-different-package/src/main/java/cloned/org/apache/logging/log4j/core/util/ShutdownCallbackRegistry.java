 ...
 * callbacks. Implementations may optionally implement {@link LifeCycle}.
 *
 * @since 2.1
 */
public interface ShutdownCallbackRegistry {
    ...
    /**
     * Shared org.apache.logging.log4j.Marker to indicate log messages corresponding to shutdown hooks.
     */
