 ...
 * org.apache.logging.log4j.ThreadContext at some point in time and can safely be passed off to other threads.  Since it is
...
class CopyOnWriteSortedArrayThreadContextMap implements ReadOnlyThreadContextMap, ObjectThreadContextMap, CopyOnWrite {
     ...
     */
    protected static final String PROPERTY_NAME_INITIAL_CAPACITY = "log4j2.org.apache.logging.log4j.ThreadContext.initial.capacity";
