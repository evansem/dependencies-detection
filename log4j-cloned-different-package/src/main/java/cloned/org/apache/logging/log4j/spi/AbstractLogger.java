 ...
 */
package cloned.org.apache.logging.log4j.spi;
...
import cloned.org.apache.logging.log4j.LogBuilder;
import cloned.org.apache.logging.log4j.LoggingException;
import cloned.org.apache.logging.log4j.Marker;
import cloned.org.apache.logging.log4j.MarkerManager;
import cloned.org.apache.logging.log4j.internal.DefaultLogBuilder;
import cloned.org.apache.logging.log4j.message.DefaultFlowMessageFactory;
import cloned.org.apache.logging.log4j.message.EntryMessage;
import cloned.org.apache.logging.log4j.message.FlowMessageFactory;
import cloned.org.apache.logging.log4j.message.Message;
import cloned.org.apache.logging.log4j.message.MessageFactory;
import cloned.org.apache.logging.log4j.message.MessageFactory2;
import cloned.org.apache.logging.log4j.message.ParameterizedMessage;
import cloned.org.apache.logging.log4j.message.ParameterizedMessageFactory;
import cloned.org.apache.logging.log4j.message.ReusableMessageFactory;
import cloned.org.apache.logging.log4j.message.SimpleMessage;
import cloned.org.apache.logging.log4j.message.StringFormattedMessage;
import cloned.org.apache.logging.log4j.status.StatusLogger;
import cloned.org.apache.logging.log4j.util.Constants;
import cloned.org.apache.logging.log4j.util.LambdaUtil;
import cloned.org.apache.logging.log4j.util.LoaderUtil;
import cloned.org.apache.logging.log4j.util.MessageSupplier;
...
/**
 * Base implementation of a org.apache.logging.log4j.Logger. It is highly recommended that any org.apache.logging.log4j.Logger implementation extend this class.
 */
public abstract class AbstractLogger implements ExtendedLogger, LocationAwareLogger, Serializable {
     ...
     *
     * @param name the logger name
     * @param messageFactory the org.apache.logging.log4j.message factory, if null then use the default org.apache.logging.log4j.message factory.
     */
    ...
    /**
     * Checks that the org.apache.logging.log4j.message factory a logger was created with is the same as the given messageFactory. If they are
     ...
     * @param messageFactory The org.apache.logging.log4j.message factory to check.
     */
    public static void checkMessageFactory(final ExtendedLogger logger, final MessageFactory messageFactory) {
        ...
        if (messageFactory != null && !loggerMessageFactory.equals(messageFactory)) {
            StatusLogger.getLogger().warn(
                    "The org.apache.logging.log4j.Logger {} was created with the org.apache.logging.log4j.message factory {} and is now requested with the "
                            + "org.apache.logging.log4j.message factory {}, which may create log events with unexpected formatting.", name,
            ...
            StatusLogger
                    .getLogger()
                    .warn("The org.apache.logging.log4j.Logger {} was created with the org.apache.logging.log4j.message factory {} and is now requested with a null "
                            + "org.apache.logging.log4j.message factory (defaults to {}), which may create log events with unexpected "
                            + "formatting.",
     ...
     * @param fqcn the fully qualified class name of this org.apache.logging.log4j.Logger implementation.
    ...
    public void traceExit(final EntryMessage message) {
        // If the org.apache.logging.log4j.message is null, traceEnter returned null because flow logging was disabled, we can optimize out calling isEnabled().
    ...
    private void readObject (final ObjectInputStream s) throws ClassNotFoundException, IOException {
        ...
        try {
            ...
            StatusLogger.getLogger().warn("Unable to initialize org.apache.logging.log4j.LogBuilder");
        }
    }
