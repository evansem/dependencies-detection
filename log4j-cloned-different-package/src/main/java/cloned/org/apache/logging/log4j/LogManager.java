package cloned.org.apache.logging.log4j;/*
...
import cloned.org.apache.logging.log4j.message.MessageFactory;
import cloned.org.apache.logging.log4j.message.StringFormatterMessageFactory;
import cloned.org.apache.logging.log4j.simple.SimpleLoggerContextFactory;
import cloned.org.apache.logging.log4j.spi.LoggerContext;
import cloned.org.apache.logging.log4j.spi.LoggerContextFactory;
import cloned.org.apache.logging.log4j.spi.Provider;
import cloned.org.apache.logging.log4j.spi.Terminable;
import cloned.org.apache.logging.log4j.status.StatusLogger;
import cloned.org.apache.logging.log4j.util.LoaderUtil;
import cloned.org.apache.logging.log4j.util.PropertiesUtil;
import cloned.org.apache.logging.log4j.util.ProviderUtil;
import cloned.org.apache.logging.log4j.util.StackLocatorUtil;
import cloned.org.apache.logging.log4j.util.Strings;

/**
 * The anchor point for the Log4j logging system. The most common usage of this class is to obtain a named
 * {@link Logger}. The method {@link #getLogger()} is provided as the most convenient way to obtain a named org.apache.logging.log4j.Logger based
...
public class LogManager {
    ...
    /**
     * The name of the root org.apache.logging.log4j.Logger.
     */
            ...
            if (ProviderUtil.hasProviders()) {
                ...
                if (factories.isEmpty()) {
                    LOGGER.error("Log4j2 could not find a logging implementation. "
                            + "Please add log4j-org.apache.logging.log4j.core to the classpath. Using SimpleLogger to log to the console...");
    ...
    /**
     * Detects if a org.apache.logging.log4j.Logger with the specified name exists. This is a convenience method for porting from version 1.
     *
     ...
     * <p>
     * WARNING - The LoggerContext returned by this method may not be the LoggerContext used to create a org.apache.logging.log4j.Logger for the
     * calling class.
     * </p>
     *
     ...
     * This is equivalent to calling {@code org.apache.logging.log4j.LogManager.shutdown(false)}.
     *
     ...
     * This is equivalent to calling {@code org.apache.logging.log4j.LogManager.shutdown(org.apache.logging.log4j.LogManager.getContext(currentContext))}.
     *
     * This call is synchronous and will block until shut down is complete.
     * This may include flushing pending log events over network connections.
     *
     * @param currentContext if true a default LoggerContext (may not be the LoggerContext used to create a org.apache.logging.log4j.Logger
     ...
     *
     * <p>
     * Note that any org.apache.logging.log4j.Logger or LoggerContext objects already created will still be valid, but they will no longer be
     * accessible through org.apache.logging.log4j.LogManager. Thus, <strong>it is a bad idea to use this method without a good reason</strong>!
     * Generally, this method should be used only during startup before any code starts caching org.apache.logging.log4j.Logger objects.
     * </p>
     *
    ...
    /**
     * Returns a formatter org.apache.logging.log4j.Logger using the fully qualified name of the calling Class as the org.apache.logging.log4j.Logger name.
     * <p>
     * This logger lets you use a {@link java.util.Formatter} string in the org.apache.logging.log4j.message to format parameters.
     * </p>
     *
     * @return The org.apache.logging.log4j.Logger for the calling class.
    ...
    /**
     * Returns a formatter org.apache.logging.log4j.Logger using the fully qualified name of the Class as the org.apache.logging.log4j.Logger name.
     * <p>
     * This logger let you use a {@link java.util.Formatter} string in the org.apache.logging.log4j.message to format parameters.
     * </p>
     * <p>
     * Short-hand for {@code getLogger(clazz, StringFormatterMessageFactory.INSTANCE)}
     * </p>
     *
     * @param clazz The Class whose name should be used as the org.apache.logging.log4j.Logger name.
     * @return The org.apache.logging.log4j.Logger, created with a {@link StringFormatterMessageFactory}
    ...
    /**
     * Returns a formatter org.apache.logging.log4j.Logger using the fully qualified name of the value's Class as the org.apache.logging.log4j.Logger name.
     * <p>
     * This logger let you use a {@link java.util.Formatter} string in the org.apache.logging.log4j.message to format parameters.
     * </p>
     * <p>
     ...
     * </p>
     *
     * @param value The value's whose class name should be used as the org.apache.logging.log4j.Logger name.
     * @return The org.apache.logging.log4j.Logger, created with a {@link StringFormatterMessageFactory}
    ...
    /**
     * Returns a formatter org.apache.logging.log4j.Logger with the specified name.
     * <p>
     * This logger let you use a {@link java.util.Formatter} string in the org.apache.logging.log4j.message to format parameters.
     * </p>
     * <p>
    ...
    /**
     * Returns a org.apache.logging.log4j.Logger with the name of the calling class.
     *
     * @return The org.apache.logging.log4j.Logger for the calling class.
     * @throws UnsupportedOperationException if the calling class cannot be determined.
     */
    ...
    /**
     * Returns a org.apache.logging.log4j.Logger using the fully qualified name of the Class as the org.apache.logging.log4j.Logger name.
     *
     * @param clazz The Class whose name should be used as the org.apache.logging.log4j.Logger name. If null it will default to the calling
     *            class.
     * @return The org.apache.logging.log4j.Logger.
     * @throws UnsupportedOperationException if {@code clazz} is {@code null} and the calling class cannot be
     *             determined.
     */
    ...
    /**
     * Returns a org.apache.logging.log4j.Logger using the fully qualified class name of the value as the org.apache.logging.log4j.Logger name.
     *
     * @param value The value whose class name should be used as the org.apache.logging.log4j.Logger name. If null the name of the calling class
    ...
    /**
     * Returns a org.apache.logging.log4j.Logger with the specified name.
     *
