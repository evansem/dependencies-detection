...
public class AbstractLifeCycle implements LifeCycle2 {
    ...
    /**
     * Gets the org.apache.logging.log4j.status logger.
     *
     * @return the org.apache.logging.log4j.status logger.
     */
    ...
    protected void setState(final LifeCycle.State newState) {
        this.state = newState;
        // Need a better string than this.toString() for the org.apache.logging.log4j.message
