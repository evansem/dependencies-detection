 ...
 */
package cloned.org.apache.logging.log4j.core.async;

import java.util.List;

import cloned.org.apache.logging.log4j.Level;
import cloned.org.apache.logging.log4j.Marker;
import cloned.org.apache.logging.log4j.ThreadContext;
import cloned.org.apache.logging.log4j.core.ContextDataInjector;
...
import cloned.org.apache.logging.log4j.core.impl.ContextDataFactory;
import cloned.org.apache.logging.log4j.core.impl.ContextDataInjectorFactory;
import cloned.org.apache.logging.log4j.core.util.Clock;
import cloned.org.apache.logging.log4j.core.util.ClockFactory;
...
import cloned.org.apache.logging.log4j.message.ReusableMessage;
...
import cloned.org.apache.logging.log4j.util.StringMap;
 ...
 * {@code -DLog4jContextSelector=org.apache.logging.log4j.org.apache.logging.log4j.core.async.AsyncLoggerContextSelector} before you obtain a
 * org.apache.logging.log4j.Logger, and all Loggers returned by org.apache.logging.log4j.LogManager.getLogger will be AsyncLoggers.
 * <p>
...
public class AsyncLogger extends Logger implements EventTranslatorVararg<RingBufferLogEvent> {
    ...
    /**
     * Constructs an {@code AsyncLogger} with the specified context, name and org.apache.logging.log4j.message factory.
     *
     * @param context context of this logger
     * @param name name of this logger
     * @param messageFactory org.apache.logging.log4j.message factory of this logger
     ...
     * (non-Javadoc)
     *
     * @see org.apache.logging.log4j.org.apache.logging.log4j.core.org.apache.logging.log4j.Logger#updateConfiguration(org.apache.logging.log4j.org.apache.logging.log4j.core.config.Configuration)
     */
    @Override
     ...
     * @param level level at which the caller wants to log the org.apache.logging.log4j.message
     * @param marker org.apache.logging.log4j.message marker
     * @param message the log org.apache.logging.log4j.message
    ...
    private void logWithVarargTranslator(final String fqcn, final Level level, final Marker marker,
        ...
        // if the Message instance is reused, there is no point in freezing its org.apache.logging.log4j.message here
        if (!isReused(message)) {
    ...
    /**
     * LOG4J2-471: prevent deadlock when RingBuffer is full and object being logged calls org.apache.logging.log4j.Logger.log() from its
     * toString() method
     *
     * @param fqcn fully qualified caller name
     * @param level log level
     * @param marker optional marker
     * @param message log org.apache.logging.log4j.message
