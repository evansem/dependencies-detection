...
import cloned.org.apache.logging.log4j.core.impl.Log4jContextFactory;
...
public final class Configurator {
    ...
    private static Log4jContextFactory getFactory() {
        ...
        if (factory instanceof Log4jContextFactory) {
            ...
            LOGGER.error("org.apache.logging.log4j.LogManager returned an instance of {} which does not implement {}. Unable to initialize Log4j.",
                    factory.getClass().getName(), Log4jContextFactory.class.getName());
            return null;
        } else {
            LOGGER.fatal("org.apache.logging.log4j.LogManager did not return a LoggerContextFactory. This indicates something has gone terribly wrong!");
            return null;
        }
    }
     ...
     * @return The LoggerContext or null if an error occurred (check the org.apache.logging.log4j.status logger).
     */
     ...
     * rollover thread is done. When this method returns, these tasks' org.apache.logging.log4j.status are undefined, the tasks may be done or
     * not.
     * </p>
     *
     * @param ctx
