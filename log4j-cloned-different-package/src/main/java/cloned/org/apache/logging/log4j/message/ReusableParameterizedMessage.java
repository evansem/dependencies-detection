...
/**
 * Reusable parameterized org.apache.logging.log4j.message. This org.apache.logging.log4j.message is mutable and is not safe to be accessed or modified by multiple
...
public class ReusableParameterizedMessage implements ReusableMessage, ParameterVisitable, Clearable {
    ...
    /**
     * Creates a reusable org.apache.logging.log4j.message.
     */
    ...
    public void clear() { // LOG4J2-1583
        ...
        // reusable org.apache.logging.log4j.message, which is responsible for clearing references.
        reserved = false;
        varargs = null;
        messagePattern = null;
        throwable = null;
