...
import cloned.org.apache.logging.log4j.core.util.Integers;
...
public abstract class AbstractAppender extends AbstractFilterable implements Appender, LocationAware {
    ...
    public static int parseInt(final String s, final int defaultValue) {
        try {
            ...
            AbstractLifeCycle.LOGGER.error("Could not parse \"{}\" as an integer,  using default value {}: {}", s, defaultValue, e);
            return defaultValue;
        }
    }
    ...
    /**
     * Handle an error with a org.apache.logging.log4j.message using the {@link ErrorHandler} configured for this Appender.
     *
    ...
    /**
     * Handle an error with a org.apache.logging.log4j.message, exception, and a logging event, using the {@link ErrorHandler} configured for
     * this Appender.
     *
     * @param msg The org.apache.logging.log4j.message.
    ...
    /**
     * Handle an error with a org.apache.logging.log4j.message and an exception using the {@link ErrorHandler} configured for this Appender.
     *
     * @param msg The org.apache.logging.log4j.message.
     * @param t The Throwable.
     */
    ...
    public void setHandler(final ErrorHandler handler) {
        if (handler == null) {
            AbstractLifeCycle.LOGGER.error("The handler cannot be set to null");
            return;
        }
        if (isStarted()) {
            AbstractLifeCycle.LOGGER.error("The handler cannot be changed once the appender is started");
            return;
        }
