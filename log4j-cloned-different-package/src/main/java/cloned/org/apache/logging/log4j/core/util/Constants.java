 ...
 */
package cloned.org.apache.logging.log4j.core.util;

import cloned.org.apache.logging.log4j.util.PropertiesUtil;
import cloned.org.apache.logging.log4j.core.layout.ByteBufferDestination;
...
public final class Constants {
    ...
    /**
     * Property name for the default org.apache.logging.log4j.status (org.apache.logging.log4j.internal log4j logging) level to use if not specified in configuration.
     */
    ...
    /**
     * Supports user request LOG4J2-898 to have the option to format a org.apache.logging.log4j.message in the background thread.
     */
     ...
     */
    public static final boolean IS_WEB_APP = cloned.org.apache.logging.log4j.util.Constants.IS_WEB_APP;
     ...
     * @since 2.6
     */
    public static final boolean ENABLE_THREADLOCALS = cloned.org.apache.logging.log4j.util.Constants.ENABLE_THREADLOCALS;

    /**
     * Kill switch for garbage-free Layout behaviour that encodes LogEvents directly into
     * {@link ByteBufferDestination}s without creating intermediate temporary
     * Objects.
     * <p>
     * {@code True} by default iff all loggers are asynchronous because system property
     * {@code Log4jContextSelector} is set to {@code org.apache.logging.log4j.org.apache.logging.log4j.core.async.AsyncLoggerContextSelector}.
     ...
     * After a large org.apache.logging.log4j.message has been delivered to the appenders, the StringBuilder is trimmed to this size.
     * <p>
