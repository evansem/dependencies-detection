...
import cloned.org.apache.logging.log4j.core.util.ArrayUtils;
...
import cloned.org.apache.logging.log4j.message.MultiformatMessage;
...
/**
 * Returns the event's rendered org.apache.logging.log4j.message in a StringBuilder.
 */
            ...
            for (final String option : options) {
                ...
                case "ANSI":
                    ...
                    StatusLogger.getLogger()
                            .warn("You requested ANSI org.apache.logging.log4j.message rendering but JANSI is not on the classpath.");
                    return null;
                case "HTML":
