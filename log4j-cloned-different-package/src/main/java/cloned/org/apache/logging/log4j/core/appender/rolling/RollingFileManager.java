...
import cloned.org.apache.logging.log4j.core.appender.FileManager;
import cloned.org.apache.logging.log4j.core.appender.ManagerFactory;
import cloned.org.apache.logging.log4j.core.appender.rolling.action.AbstractAction;
import cloned.org.apache.logging.log4j.core.appender.rolling.action.Action;
...
public class RollingFileManager extends FileManager {
    ...
    public boolean releaseSub(final long timeout, final TimeUnit timeUnit) {
        ...
        try {
            ...
            // Preserve interrupt org.apache.logging.log4j.status
            Thread.currentThread().interrupt();
        }
        LOGGER.debug("RollingFileManager shutdown completed with org.apache.logging.log4j.status {}", status);
        return status;
    }
