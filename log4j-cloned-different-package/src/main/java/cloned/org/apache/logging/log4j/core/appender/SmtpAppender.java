...
import cloned.org.apache.logging.log4j.core.config.plugins.validation.constraints.ValidPort;
import cloned.org.apache.logging.log4j.core.filter.ThresholdFilter;
import cloned.org.apache.logging.log4j.core.layout.HtmlLayout;
import cloned.org.apache.logging.log4j.core.net.SmtpManager;
import cloned.org.apache.logging.log4j.core.net.ssl.SslConfiguration;
 ...
 * application context.
 *
 * By default, an email org.apache.logging.log4j.message will formatted as HTML. This can be modified by
 * setting a layout for the appender.
 *
 * By default, an email org.apache.logging.log4j.message will be sent when an ERROR or higher severity
 * org.apache.logging.log4j.message is appended. This can be modified by setting a filter for the
 * appender.
 */
...
public final class SmtpAppender extends AbstractAppender {
    ...
    public static class Builder extends AbstractAppender.Builder<Builder>
            implements cloned.org.apache.logging.log4j.core.util.Builder<SmtpAppender> {
        ...
        /**
         * Specifies the layout used for the email org.apache.logging.log4j.message body. By default, this uses the
    ...
    public static SmtpAppender createAppender(
        ...
        final int smtpPort = parseInt(smtpPortStr, 0);
