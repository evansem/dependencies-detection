 ...
 */
package cloned.org.apache.logging.log4j.util;
...
public final class Constants {
    ...
    /**
     * Name of the system property that will turn on TRACE level org.apache.logging.log4j.internal log4j2 org.apache.logging.log4j.status logging.
     * <p>
     * If system property {@value} is defined, regardless of the property value, all org.apache.logging.log4j.internal log4j2 logging will be
     * printed to the console. The presence of this system property overrides any value set in the configuration's
     * {@code <Configuration org.apache.logging.log4j.status="<level>" ...>} org.apache.logging.log4j.status attribute, as well as any value set for
