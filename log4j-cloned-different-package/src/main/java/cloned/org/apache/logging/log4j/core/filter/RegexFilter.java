...
/**
 * This filter returns the onMatch result if the org.apache.logging.log4j.message matches the regular expression.
 *
...
public final class RegexFilter extends AbstractFilter {
     ...
     * @param useRawMsg
     *        If true, the raw org.apache.logging.log4j.message will be used, otherwise the formatted org.apache.logging.log4j.message will be used.
     * @param match
    ...
    public static RegexFilter createFilter(
        ...
        if (regex == null) {
            AbstractLifeCycle.LOGGER.error("A regular expression must be provided for RegexFilter");
            return null;
        }
