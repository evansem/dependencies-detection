 ...
 */
package cloned.org.apache.logging.log4j.status;
...
import cloned.org.apache.logging.log4j.message.ParameterizedNoReferenceMessageFactory;
import cloned.org.apache.logging.log4j.simple.SimpleLogger;
import cloned.org.apache.logging.log4j.simple.SimpleLoggerContext;
 ...
 * Normally, the Log4j StatusLogger is configured via the root {@code <Configuration org.apache.logging.log4j.status="LEVEL"/>} node in a Log4j
...
public final class StatusLogger extends AbstractLogger {
     ...
     */
    public static final String MAX_STATUS_ENTRIES = "log4j2.org.apache.logging.log4j.status.entries";
     ...
     * in the org.apache.logging.log4j.status logger output. See {@link java.text.SimpleDateFormat} for supported formats.
     * @since 2.11.0
     */
    ...
    // LOG4J2-1176: normal parameterized org.apache.logging.log4j.message remembers param object, causing memory leaks.
    ...
    private StatusLogger(final String name, final MessageFactory messageFactory) {
        ...
        // LOG4J2-1813 if system property "log4j2.debug" is defined, print all org.apache.logging.log4j.status logging
    ...
    /**
     * Clears the list of org.apache.logging.log4j.status events and listeners.
     */
    public void reset() {
        listenersLock.writeLock().lock();
        try {
    ...
    /**
     * Clears the list of org.apache.logging.log4j.status events.
     */
    public void clear() {
        msgLock.lock();
        try {
     ...
     * Adds an event.
     *
     * @param marker The org.apache.logging.log4j.Marker
     * @param fqcn The fully qualified class name of the <b>caller</b>
     * @param level The logging level
     * @param msg The org.apache.logging.log4j.message associated with the event.
    ...
    public void logMessage(final String fqcn, final Level level, final Marker marker, final Message msg,
        ...
        // LOG4J2-1813 if system property "log4j2.debug" is defined, all org.apache.logging.log4j.status logging is enabled
        if (isDebugPropertyEnabled()) {
    ...
    /**
     * Queues for org.apache.logging.log4j.status events.
     *
