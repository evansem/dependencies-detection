...
package cloned.org.apache.logging.log4j.core.appender.mom.kafka;
...
public final class KafkaAppender extends AbstractAppender {
	...
	public static class Builder<B extends Builder<B>> extends AbstractAppender.Builder<B>
			implements cloned.org.apache.logging.log4j.core.util.Builder<KafkaAppender> {
	...
	public void append(final LogEvent event) {
		if (event.getLoggerName() != null && event.getLoggerName().startsWith("org.apache.kafka")) {
			AbstractLifeCycle.LOGGER.warn("Recursive logging from [{}] for appender [{}].", event.getLoggerName(), getName());
		} else {
			try {
				tryAppend(event);
