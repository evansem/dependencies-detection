...
package cloned.org.apache.logging.log4j.core.appender.mom.jeromq;
...
public final class JeroMqAppender extends AbstractAppender {
    ...
    public static JeroMqAppender createAppender(
        ...
        AbstractLifeCycle.LOGGER.debug("Creating JeroMqAppender with name={}, filter={}, layout={}, ignoreExceptions={}, endpoints={}",
    ...
    public synchronized void append(final LogEvent event) {
        ...
        if (manager.send(getLayout().toByteArray(event))) {
            ...
            sendRcFalse++;
            AbstractLifeCycle.LOGGER.error("Appender {} could not send org.apache.logging.log4j.message {} to JeroMQ {}", getName(), sendRcFalse, formattedMessage);
        }
    }
