 ...
 *     org.apache.logging.log4j.ThreadContext use cases, the constants dominate performance more than the asymptotic performance of the
 *     algorithms used.
 *     </li>
...
public class SortedArrayStringMap implements IndexedStringMap {
    ...
    static {
        ...
        try {
            if (setMethod != null) {
                final Class<?> clazz = Class.forName("cloned.log4j.org.apache.logging.log4j.util.org.apache.logging.log4j.internal.DefaultObjectInputFilter");
