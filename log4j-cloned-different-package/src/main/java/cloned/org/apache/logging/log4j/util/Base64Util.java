...
public final class Base64Util {
    ...
    static {
        try {
            Class<?> clazz = LoaderUtil.loadClass("java.org.apache.logging.log4j.util.Base64");
            Class<?> encoderClazz = LoaderUtil.loadClass("java.org.apache.logging.log4j.util.Base64$Encoder");
