...
public class SimpleMessage implements Message, StringBuilderFormattable, CharSequence {
    ...
    /**
     * Constructor that includes the org.apache.logging.log4j.message.
     * @param message The String org.apache.logging.log4j.message.
     */
    ...
    /**
     * Constructor that includes the org.apache.logging.log4j.message.
     * @param charSequence The CharSequence org.apache.logging.log4j.message.
     */
    public SimpleMessage(final CharSequence charSequence) {
        // this.org.apache.logging.log4j.message = String.valueOf(charSequence); // postponed until getFormattedMessage
    ...
    private void writeObject(final ObjectOutputStream out) throws IOException {
        getFormattedMessage(); // initialize the org.apache.logging.log4j.message:String field
