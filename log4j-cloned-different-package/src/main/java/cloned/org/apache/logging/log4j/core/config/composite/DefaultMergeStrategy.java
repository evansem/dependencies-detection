 ...
 */
package cloned.org.apache.logging.log4j.core.config.composite;
 ...
 * configurations with the exception that the highest org.apache.logging.log4j.status level and the lowest monitorInterval greater than 0 will
 * be used.</li>
 ...
 * <li>Loggers are all aggregated. org.apache.logging.log4j.Logger attributes are individually merged with duplicates being replaced by those
 * in later configurations. Appender references on a org.apache.logging.log4j.Logger are aggregated with duplicates being replaced by those in
 * later configurations. Filters on a org.apache.logging.log4j.Logger are aggregated under a CompositeFilter if more than one Filter is defined.
