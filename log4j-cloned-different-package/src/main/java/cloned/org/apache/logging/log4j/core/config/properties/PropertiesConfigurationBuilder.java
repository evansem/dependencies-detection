...
package cloned.org.apache.logging.log4j.core.config.properties;
...
import cloned.org.apache.logging.log4j.core.config.ConfigurationException;
...
import cloned.org.apache.logging.log4j.core.config.builder.api.AppenderComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.AppenderRefComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.ComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.ConfigurationBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.ConfigurationBuilderFactory;
import cloned.org.apache.logging.log4j.core.config.builder.api.FilterComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.FilterableComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.LayoutComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.LoggableComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.LoggerComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.RootLoggerComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.ScriptComponentBuilder;
import cloned.org.apache.logging.log4j.core.config.builder.api.ScriptFileComponentBuilder;
import cloned.org.apache.logging.log4j.core.filter.AbstractFilter.AbstractFilterBuilder;
import cloned.org.apache.logging.log4j.core.util.Builder;
...
public class PropertiesConfigurationBuilder extends ConfigurationBuilderFactory
    ...
    private LoggerComponentBuilder createLogger(final String key, final Properties properties) {
        ...
        if (Strings.isEmpty(name)) {
            throw new ConfigurationException("No name attribute provided for org.apache.logging.log4j.Logger " + key);
        }
        final String level = Strings.trimToNull((String) properties.remove("level"));
        final String type = (String) properties.remove(CONFIG_TYPE);
        ...
        if (type != null) {
            if (type.equalsIgnoreCase("asyncLogger")) {
                ...
                throw new ConfigurationException("Unknown org.apache.logging.log4j.Logger type " + type + " for org.apache.logging.log4j.Logger " + name);
            }
        } else {
            if (location != null) {
                includeLocation = Boolean.parseBoolean(location);
    ...
    private RootLoggerComponentBuilder createRootLogger(final Properties properties) {
        ...
        if (type != null) {
            if (type.equalsIgnoreCase("asyncRoot")) {
                ...
                throw new ConfigurationException("Unknown org.apache.logging.log4j.Logger type for root logger" + type);
            }
        } else {
            if (location != null) {
                includeLocation = Boolean.parseBoolean(location);
