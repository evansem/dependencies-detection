...
import cloned.org.apache.logging.log4j.core.config.plugins.PluginNode;
...
public class AppenderSet {
    ...
    public static class Builder implements cloned.org.apache.logging.log4j.core.util.Builder<AppenderSet> {
