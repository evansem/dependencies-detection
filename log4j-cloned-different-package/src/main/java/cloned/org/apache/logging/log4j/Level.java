...
import cloned.org.apache.logging.log4j.spi.StandardLevel;
...
public final class Level implements Comparable<Level>, Serializable {
    ...
    /**
     * A fine-grained debug org.apache.logging.log4j.message, typically capturing the flow through the application.
     */
     ...
     * @since 2.1
     */
    public static final String CATEGORY = "org.apache.logging.log4j.Level";
    ...
    private Level(final String name, final int intLevel) {
        if (Strings.isEmpty(name)) {
            throw new IllegalArgumentException("Illegal null or empty org.apache.logging.log4j.Level name.");
        }
        if (intLevel < 0) {
            throw new IllegalArgumentException("Illegal org.apache.logging.log4j.Level int less than zero.");
        }
        this.name = name;
        this.intLevel = intLevel;
        this.standardLevel = StandardLevel.getStandardLevel(intLevel);
        if (LEVELS.putIfAbsent(name, this) != null) {
            throw new IllegalStateException("org.apache.logging.log4j.Level " + name + " has already been defined.");
        }
    }

    /**
     * Gets the integral value of this org.apache.logging.log4j.Level.
     *
     * @return the value of this org.apache.logging.log4j.Level.
     */
    public int intLevel() {
    ...
    /**
     * Gets the standard org.apache.logging.log4j.Level values as an enum.
     *
     ...
     * @param level
     *            The level to test.
     * @return True if this level org.apache.logging.log4j.Level is less specific or the same as the given org.apache.logging.log4j.Level.
     */
     ...
     * @return True if this level org.apache.logging.log4j.Level is more specific or the same as the given org.apache.logging.log4j.Level.
     */
    ...
    /**
     * Gets the symbolic name of this org.apache.logging.log4j.Level. Equivalent to calling {@link #toString()}.
     *
     * @return the name of this org.apache.logging.log4j.Level.
     */
    public String name() {
        return this.name;
    }
    ...
    /**
     * Retrieves an existing org.apache.logging.log4j.Level or creates on if it didn't previously exist.
     *
     * @param name The name of the level.
     * @param intValue The integer value for the org.apache.logging.log4j.Level. If the level was previously created this value is ignored.
     * @return The org.apache.logging.log4j.Level.
     * @throws IllegalArgumentException if the name is null or intValue is less than zero.
     */
    ...
    /**
     * Return the org.apache.logging.log4j.Level associated with the name or null if the org.apache.logging.log4j.Level cannot be found.
     *
     * @param name The name of the org.apache.logging.log4j.Level.
     * @return The org.apache.logging.log4j.Level or null.
     */
     ...
     * {@link #DEBUG}.
     *
     * @param sArg The name of the desired org.apache.logging.log4j.Level.
     * @return The org.apache.logging.log4j.Level associated with the String.
     */
     ...
     *
     * @param name The name of the desired org.apache.logging.log4j.Level.
     * @param defaultLevel The org.apache.logging.log4j.Level to use if the String is invalid.
     * @return The org.apache.logging.log4j.Level associated with the String.
     */
    ...
    /**
     * Return the org.apache.logging.log4j.Level associated with the name.
     *
     * @param name The name of the org.apache.logging.log4j.Level to return.
     * @return The org.apache.logging.log4j.Level.
     * @throws NullPointerException if the org.apache.logging.log4j.Level name is {@code null}.
     * @throws IllegalArgumentException if the org.apache.logging.log4j.Level name is not registered.
     */
     ...
     * @throws IllegalArgumentException if the specified enum type has no constant with the specified name, or
     *             the specified class object does not represent an enum type
     * @throws NullPointerException if {@code enumType} or {@code name} are {@code null}
