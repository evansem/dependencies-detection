...
import cloned.org.apache.logging.log4j.message.StringMapMessage;

/**
 * Formats a {@link LogEvent} in its {@link Message} form.
 * <p>
 * Useful in combination with a JMS Appender to map a Log4j {@link MapMessage} or
 * {@link StringMapMessage} to a JMS {@link javax.jms.MapMessage}.
 * </p>
 */
