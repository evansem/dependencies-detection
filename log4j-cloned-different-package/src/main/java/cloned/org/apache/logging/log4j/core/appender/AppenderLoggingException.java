 ...
 * using the {@link StatusLogger}. Appenders should only throw exceptions when an error
 ...
 * that instruction. See {@link Appender#ignoreExceptions()}, which is the standard
 * way to do this.
 * </p>
 */
public class AppenderLoggingException extends LoggingException {
    ...
    /**
     * Constructs an exception with a org.apache.logging.log4j.message.
     *
    ...
    /**
     * Constructs an exception with a org.apache.logging.log4j.message and underlying cause.
     *
     * @param message The reason for the exception
