...
import cloned.org.apache.logging.log4j.core.impl.MutableLogEvent;
import cloned.org.apache.logging.log4j.core.impl.ReusableLogEventFactory;
import cloned.org.apache.logging.log4j.core.jmx.RingBufferAdmin;
import cloned.org.apache.logging.log4j.core.util.Log4jThread;
import cloned.org.apache.logging.log4j.core.util.Log4jThreadFactory;
...
public class AsyncLoggerConfigDisruptor extends AbstractLifeCycle implements AsyncLoggerConfigDelegate {
    ...
    private LogEvent prepareEvent(final LogEvent event) {
        ...
        if (logEvent.getMessage() instanceof ReusableMessage) {
            if (logEvent instanceof Log4jLogEvent) {
                ...
                // That translator calls MutableLogEvent.initFrom to copy the event, which will makeMessageImmutable the org.apache.logging.log4j.message.
        ...
        } else { // org.apache.logging.log4j.message is not a ReusableMessage; makeMessageImmutable it to prevent ConcurrentModificationExceptions
    ...
    private void showWarningAboutCustomLogEventWithReusableMessage(final LogEvent logEvent) {
        if (!alreadyLoggedWarning) {
            LOGGER.warn("Custom log event of type {} contains a mutable org.apache.logging.log4j.message of type {}." +
                            " AsyncLoggerConfig does not know how to make an immutable copy of this org.apache.logging.log4j.message." +
                            " This may result in ConcurrentModificationExceptions or incorrect log messages" +
                            " if the application modifies objects in the org.apache.logging.log4j.message while" +
     ...
     * (non-Javadoc)
     *
     * @see org.apache.logging.log4j.org.apache.logging.log4j.core.async.AsyncLoggerConfigDelegate#createRingBufferAdmin(java.lang.String,
     * java.lang.String)
     */
    @Override
