...
import cloned.org.apache.logging.log4j.core.appender.OutputStreamManager;
 ...
 * implementation of {@link AbstractManager} to handle external resources
 * such as streams, connections, and other shared state. As Appenders are plugins, concrete implementations need to
 * be annotated with {@link Plugin} and need to provide a static
 * factory method annotated with {@link PluginFactory}.
 *
 * <p>Most org.apache.logging.log4j.core plugins are written using a related Manager class that handle the actual task of serializing a
 * {@link LogEvent} to some output location. For instance, many Appenders can take
 * advantage of the {@link OutputStreamManager} class.</p>
 *
...
public interface Appender extends LifeCycle {
    ...
    /**
     * Main {@linkplain Plugin#elementType() plugin element type} for
     * Appender plugins.
     *
     * @since 2.6
     */
