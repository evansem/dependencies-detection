...
public enum Severity {
    ...
    /**
     * Returns the Severity for the specified org.apache.logging.log4j.Level.
    ...
    public static Severity getSeverity(final Level level) {
        switch (level.getStandardLevel()) {
            case StandardLevel.ALL:
                return DEBUG;
            case StandardLevel.TRACE:
                return DEBUG;
            case StandardLevel.DEBUG:
                return DEBUG;
