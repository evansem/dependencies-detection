 ...
 */
package cloned.org.apache.logging.log4j.core;
...
import cloned.org.apache.logging.log4j.core.config.LocationAwareReliabilityStrategy;
import cloned.org.apache.logging.log4j.core.config.LoggerConfig;
import cloned.org.apache.logging.log4j.core.config.ReliabilityStrategy;
import cloned.org.apache.logging.log4j.core.filter.CompositeFilter;
import cloned.org.apache.logging.log4j.message.Message;
import cloned.org.apache.logging.log4j.message.MessageFactory;
import cloned.org.apache.logging.log4j.message.SimpleMessage;
import cloned.org.apache.logging.log4j.spi.AbstractLogger;
import cloned.org.apache.logging.log4j.util.Strings;
import cloned.org.apache.logging.log4j.util.Supplier;

/**
 * The org.apache.logging.log4j.core implementation of the {@link cloned.org.apache.logging.log4j.Logger} interface. Besides providing an implementation
 * of all the org.apache.logging.log4j.Logger methods, this class also provides some convenience methods for Log4j 1.x compatibility as well as
 * access to the {@link Filter Filters} and {@link Appender
 * Appenders} associated with this org.apache.logging.log4j.Logger. Note that access to these underlying objects is provided primarily for use in
 ...
 * be able to examine the org.apache.logging.log4j.message pattern and parameters. (RG) Moving the isEnabled methods out of org.apache.logging.log4j.Logger noticeably
 * impacts performance. The org.apache.logging.log4j.message pattern and parameters are required so that they can be used in global filters.
 */
public class Logger extends AbstractLogger implements Supplier<LoggerConfig> {
     ...
     * The constructor.
     *
     * @param context The LoggerContext this org.apache.logging.log4j.Logger is associated with.
     * @param messageFactory The org.apache.logging.log4j.message factory.
     * @param name The name of the org.apache.logging.log4j.Logger.
     */
    ...
    /**
     * This method is only used for 1.x compatibility. Returns the parent of this org.apache.logging.log4j.Logger. If it doesn't already exist
     * return a temporary org.apache.logging.log4j.Logger.
     *
     * @return The parent org.apache.logging.log4j.Logger.
     */
    ...
    /**
     * Returns the LoggerContext this org.apache.logging.log4j.Logger is associated with.
     *
     ...
     * </p>
     *
     * @param level The org.apache.logging.log4j.Level to use on this org.apache.logging.log4j.Logger, may be null.
     */
     ...
     * (non-Javadoc)
     *
     * @see org.apache.logging.log4j.org.apache.logging.log4j.util.Supplier#get()
     */
    @Override
     ...
     *
     * @param appender The Appender to add to the org.apache.logging.log4j.Logger.
     */
     ...
     * This method is not exposed through the public API and is used primarily for unit testing.
     *
     * @param appender The Appender to remove from the org.apache.logging.log4j.Logger.
     */
     ...
     * This method is not exposed through the public API and is used primarily for unit testing.
     *
     * @return An Iterator over all the Filters associated with the org.apache.logging.log4j.Logger.
     */
     ...
     * This method is not exposed through the public API and is used primarily for unit testing.
     *
     * @return The number of Filters associated with the org.apache.logging.log4j.Logger.
     */
     ...
     * bridge.
     *
     * @param additive Boolean value to indicate whether the org.apache.logging.log4j.Logger is additive or not.
     */
    ...
    /**
     * Associates this org.apache.logging.log4j.Logger with a new Configuration. This method is not
    ...
    /**
     * The binding between a org.apache.logging.log4j.Logger and its configuration.
     */
    protected class PrivateConfig {
        // config fields are public to make them visible to org.apache.logging.log4j.Logger subclasses
    ...
    /**
     * Serialization proxy class for org.apache.logging.log4j.Logger. Since the LoggerContext and config information can be reconstructed on the
     * fly, the only information needed for a org.apache.logging.log4j.Logger are what's available in AbstractLogger.
     *
     * @since 2.5
     */
     ...
     *
     * @return A String describing this org.apache.logging.log4j.Logger instance.
     */
    @Override
    public String toString() {
